    ...
    <div id="content" role="main">
        <div id="slide-home">
            <div class="slides_container">
                <div class="slide">
                    <img src="img/iluminacao-publica-01.jpg" alt="Iluminação Pública" width="679" height="264" />
                </div>

                <div class="slide">
                    <img src="img/iluminacao-publica-02.jpg" alt="Iluminação Pública" width="679" height="264" />
                </div>

                <div class="slide">
                    <img src="img/iluminacao-publica-03.jpg" alt="Iluminação Pública" width="679" height="264" />
                </div>

                <div class="slide">
                    <img src="img/iluminacao-publica-04.jpg" alt="Iluminação Pública" width="679" height="264" />
                </div>

                <div class="slide">
                    <img src="img/iluminacao-publica-05.jpg" alt="Iluminação Pública" width="679" height="264" />
                </div>

                <div class="slide">
                    <img src="img/iluminacao-publica-06.jpg" alt="Iluminação Pública" width="679" height="264" />
                </div>
            </div><!-- FINAL SLIDES CONTAINER -->
        ...
        <div class="home-bottom">
            <p class="bt-repr"><a href="representantes.php" title="Conheça Nossos Representantes" class="link">Conheça Nossos <span>Representantes</span></a></p>
